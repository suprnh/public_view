...
@section('leftbar')
   <?php
		...
		$user_details = get_user_detail_by_id(get_current_user_id()); 
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li  style="display:{{$settings}}" class="{{ Request::is('iamadmin/dashboard/edit-user/*') ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li style="display:{{$settings}}" class="{{ Request::is('iamadmin/dashboard/general-settings') ? 'active' : '' }}">
                            <a href="{{ route('general-settings') }}">{{ _tr('General Settings') }}</a>
                        </li>
                        <li style="display:{{$settings}}" class="{{ Request::is('iamadmin/dashboard/edit-profile') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('landing-page-video') }}"><i class="fa fa-file-video-o fa-fw"></i>{{ _tr('Videos') }}<span class="fa arrow"></span></a>
                    <!-- <ul class="nav nav-second-level"> -->

                ...
                <div class="user-content">
					...
					@include('frontend.section.msg')
                        ...
                        <div class="status status-thank">
                            ...
                            <span class="status-text ky">Thank you! You have completed the process for your Identity verification.</span>
                        ...
                        <div class="status status-process">
                            ...
                            <span class="status-text ky">Your Application under Process for Varification.</span>
                        ...
                        <div class="status status-canceled">
                            ...
                            <span class="status-text ky">Your application rejected by admin.</span>
                        ...
                        <div class="status status-warnning">
                            ...
                            <span class="status-text ky">We found some information missing in application.</span>
                        ...
                        <div class="status status-verified">
                            ...
                            <span class="status-text ky">Your Identity Verified.</span>

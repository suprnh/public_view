	...
	<div class="user-panel">
		...
		<div class="transaction-i">
				...
				<div class="row">
					...
					<div class="col-md-6">
							<div class="input-item input-with-label">
								...
								<select class="country-select" name="currency" id="currency">
									...
									<option value="sol" <?php selected('sol',old('currency')); ?>>SOL</option>
								</select>
					...
					<div class="col-md-6">
						<div class="input-item input-with-label">
							<label for="phone-number" class="input-item-label">{{ __t('Contribution Amount in crypto ETH/BTC/USDT/BNB/ADA/SOL') }}</label>
					...
					<div class="col-md-12">
						  <div class="input-item text-left">
								...
								<label for="aggrement" style="color:#3f51b5 !important; font-weight: 600;">{{ __t('I hereby confirm that all the details provided are correct. I will be solely responsible for any wrong entry.') }}</label>
						  </div>
				...
				<div class="row mt-4">
                    <div class="col-lg-12">
                        <div class="rewars_rules">
                            ...
                            <ul>
                                <li>1. Select The Currency you have paid. Example: ETH</li>
                                <li>2. Enter the Amount in crypto. Example: 0.4567 ETH</li>

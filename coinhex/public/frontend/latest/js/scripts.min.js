...
$(function() {
	...
	$(document).ready(function(){
			...
			submitHandler: function (form) {
				...
				$.ajax({
					...
					success: function (response) {
						$('#myModal .modal-content').addClass('popup-form-content');
						...
						if(response.message != undefined) {
							modal.getElementsByClassName("modal-body")[0].innerHTML = response.message;
							...
							if(error_msg !=''){
							modal.getElementsByClassName("modal-body")[0].innerHTML = '<div class="error-msg"><ul>'+error_msg+'</ul></div>';
							} else {
		...
		var myChart = new Chart(ctx, {
			type: 'doughnut',
			data: {
				labels: ["Sale", "Private Sale", "Management, R&D", "Team & Advisor", "Reserve", "Marketing"],
				datasets: [{
					label: '# of Votes',
					data: [40, 10, 20, 15, 10, 5],
					backgroundColor: [
						'#77c0f6',
						'#6f50fd',
						'#f3d667',

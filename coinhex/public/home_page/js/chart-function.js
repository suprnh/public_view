...
==================================*/    
    ...
    function chart(){
      ...
      var colors = ['#283164', '#e91e63', '#673ab7', '#009688', '#79abdb','#3f51b5', '#f44336', '#2196f3', '#607d8b', '#795548','#4caf50', '#2196f3'];

      var labels = ["Angel Round  (1%)", "Seed Round (1%)","Post-Seed Round (2%)","Pre ICO Round  (2%)","ICO 1 Public Round (25%)","IDOs /Exchange Listings (25%)","Liquidity Requirements (2%)","Marketing (5%)","Development /Operations (2%)","Advisory (5%)","Team Reserve (10%)","Foundation Reserve (20%)"];

      var data = [1, 1, 2, 2, 25, 25, 2, 5, 2, 5, 10, 20];

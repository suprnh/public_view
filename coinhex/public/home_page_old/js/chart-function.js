...
==================================*/    
    ...
    function chart(){
      /* Layout 1 Token Chat */  
      var colors = ['#3e609b', '#ee8c4b', '#aeaeae', '#fec934', '#79abdb', '#89bc68', '#6b8fce', '#c26427', '#767676', '#bf9417', '#90acdb', '#7fb35d', '#557bbc', '#f2ab7b', '#629046'];
      var labels = ["Team (5%)", "Founding (2%)", "Seed Placement (1.5%)", "Private Placement (2%)", "Private/Corporate Placement (2%)", "Public Allocation (2%)","Game Play Incentive (30%)","Game play features (6.5%)","Token Stake Incentive (10%)","Liquidity (10%)","Listing Fees (1%)","Development (15%)","Marketing (10%)","Airdrop (1%)","Advisor (1.5%)"];
      var data = [5, 2, 1.5, 2, 2, 2, 30, 6.5, 10, 10, 1, 15, 10, 1, 1.5];
      ...
      legendHolder.innerHTML = legend;
       ...
       /* Layout 2 Token Chat */
      var layout2colors = ['#3e609b', '#ee8c4b', '#aeaeae', '#fec934', '#79abdb', '#89bc68', '#6b8fce', '#c26427', '#767676', '#bf9417', '#90acdb', '#7fb35d', '#557bbc', '#f2ab7b', '#629046'];
      var layout2labels = ["Team (5%)", "Founding (2%)", "Seed Placement (1.5%)", "Private Placement (2%), Private/Corporate Placement (2%)", "Public Allocation (2%)","Game Play Incentive (30%)","Game play features (6.5%)","Token Stake Incentive (10%)","Liquidity (10%)","Listing Fees (1%)","Development (15%)","Marketing (10%)","Airdrop (1%)","Advisor (1.5%)"];

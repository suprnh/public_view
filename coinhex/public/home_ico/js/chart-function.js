...
==================================*/    
    ...
    function chart(){
      /* Layout 1 Token Chat */
      var colors = ['#17D7FF', '#673ab7', '#0d7aab',  '#009688','#f44336','#8bc34a','#ff9800','#af26e0'];
      var labels = ["Reserve: 30%", " Partnership: 15%", "Team: 12.5% (Locked 1-3 years)","Liquidity: 8%","Community Pool: 4% (Locked 1 year)","ICO Pre-Sale: 15%","ICO Sale-Sale: 11.5%"," Advisors: 5%"];
      var data = [30, 15, 12.5, 8, 4, 15, 11.5, 5];
      var bgColor = colors;
      var dataChart = {
        labels: labels,
        datasets: [{
